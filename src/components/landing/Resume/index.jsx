...
import ResumePDF from '/static/resume-suvankar-satpati.pdf'
        ...
        <ResumeWraper id="resume">
            ...
            <div theme={theme} >
                ...
                <div class="stuff">
                    ...
                    <ul>
                        <Employer name="Thoughtworks" duration="une 2018 - Present" post="Senior 
                    ...
                    <Employer name="West Bengal University of Technology" duration="JJuly 2006 - July 2010" post="Kolkata, India" />
                    <ul>
